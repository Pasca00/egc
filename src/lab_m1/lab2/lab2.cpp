...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.2, 0.8, 0.2), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(1, 0, 1), glm::vec3(0.2, 0.2, 0.5), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(0, 1, 1), glm::vec3(0.9, 0.3, 0), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(1, 1, 1), glm::vec3(0.2, 0.4, 1), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.5, 1, 1), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.1, 0.4, 0.4), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.2, 0.8, 0.6), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 0, 0.8), glm::vec3(0, 0, 0)),
        };
        ...
        std::vector<VertexFormat> tetrahedronVertices{
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0.3f, 0.8f, 1), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.5f, 1, 0), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0.2f, 0.1f, 1), glm::vec3(0, 0, 0)),
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0, 0), glm::vec3(0, 0, 0)),
        };
        ...
        CreateMesh("tetrahedron", tetrahedronVertices, tetrahedronIndices);
    }
    ...
    std::vector<VertexFormat> vertices{
        VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.3f, 0.8f, 1), glm::vec3(0, 0, 0)),
        VertexFormat(glm::vec3(2, 0, 0), glm::vec3(0.3f, 0.8f, 1), glm::vec3(0, 0, 0)),
        VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.3f, 0.8f, 1), glm::vec3(0, 0, 0)),
        VertexFormat(glm::vec3(2, 1, 0), glm::vec3(0.3f, 0.8f, 1), glm::vec3(0, 0, 0))
    };
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(1.5f, 2.0f, 0), glm::vec3(0.25f));
    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(0, 0, 0));
    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(3, 0, 0));
