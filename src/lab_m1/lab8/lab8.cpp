...
void Lab8::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    glUniform1i(glGetUniformLocation(shader->program, "isSpotlight"), isSpotlight);
    glUniform1f(glGetUniformLocation(shader->program, "cut_off"), cut_off);
